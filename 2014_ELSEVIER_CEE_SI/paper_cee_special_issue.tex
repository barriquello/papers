...
\sout{The IP protocol is an open, mature and field proven technology, with free and well documented standards know as RFCs \rev{(Request for Comments)}, and thus it is very reasonable to reuse it for wireless sensor networking instead of creating new proprietary protocols.} \sout{However, 6LoWPAN protocol does not define the routing protocol, which shall be defined apart. Thus, IETF has standardized RPL as the routing protocol for IP-based LLNs}.
