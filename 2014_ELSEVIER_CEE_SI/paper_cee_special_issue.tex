...
The \textit{GeoRank} operation is depicted in Algoritm \ref{alg}.
...
Consider a RPL network $G$ comprised of a set $S$ of nodes and a set $B$ of border routers (DODAGs root). We first introduce the concept of Rank and DODAG preferred parent.
